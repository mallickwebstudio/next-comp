...
export default function LongFormContentThree() {
  ...
  return (
    ...
    >
      <div className="container mx-auto p-6 sm:py-10  md:p-12 lg:py-16 grid grid-cols-1 md:grid-cols-[1fr_auto] gap-12">
        ...
        {/* Aside Links, Newsletter Signup */}
        <div className="md:sticky top-8 h-fit">
          {/* Link */}
          <div className="p-4 md:w-xs border rounded-md">
          ...
          {/* Newsletter */}
          <div className="mt-4 p-4 md:w-xs border rounded-md">
