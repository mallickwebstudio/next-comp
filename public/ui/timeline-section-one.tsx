...
export default function TimelineSectionOne() {
    return (
        ...
        >
            <div className="
            container mx-auto p-6 sm:py-10  md:p-12 lg:py-16 
            relative grid grid-cols-1 md:grid-cols-2 auto-rows-auto auto-cols-fr gap-x-32 gap-y-12 items-start justify-items-center
                    ">
                {/* Text Content */}
                <header className="md:sticky md:top-12">
                ...
                md:justify-self-auto md:row-start-auto md:row-end-auto md:col-start-auto md:col-end-auto 
                ">
                    {/* Top fade overlay */}
                ...
                {/* Timeline Data */}
                <div className="ml-12 md:ml-0 py-8 w-full space-y-12">
                    {timelineData.map((item, index) => (
                        <div
                            className="relative"
                            key={item.title + index + "TimelineSectionOne"}
                        >
                            <div className="absolute -left-[31px] md:-left-[72px] top-2 p-2 size-3 bg-foreground flex items-center justify-center outline-4 outline-background rounded-full" />
