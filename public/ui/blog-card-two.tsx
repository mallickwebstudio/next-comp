        ...
        <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3">
          {blogData.map((item, index) => (
            <article
              ...
              key={item.title + index + "Card" + "BlogCardOne"}
              itemScope
            ...
            >
              ...
              <header className="px-3 mt-3 flex-1">
              ...
              <div className="px-3 my-3 flex gap-3 items-center" itemProp="author" itemScope itemType="https://schema.org/Person">
                <Image
