...
export default function ProductListSectionFour() {
  return (
    <section
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2 md:grid-cols-3">
          {productData.map((item, index) => (
            <article
              ...
              key={item.name + index + "ProductListSectionFour"}
              itemScope
            ...
            >
              ...
              <header className="mt-2 flex flex-col justify-center items-center text-center">
