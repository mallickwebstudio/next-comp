        ...
        "blocks": [
          {
            ...
            "thumbnail": "/images/ui/event-header/event-header-one.png",
            "path": "/src/ui/section/event-header/event-header-one.tsx"
          },
          {
            "slug": "event-header-two",
            "id": "event-header-two",
            "name": "Event Header Two",
            "thumbnail": "/images/ui/event-header/event-header-two.png",
            "path": "/src/ui/section/event-header/event-header-two.tsx"
          },
          {
            "slug": "event-header-three",
            "id": "event-header-three",
            "name": "Event Header Three",
            "thumbnail": "/images/ui/event-header/event-header-three.png",
            "path": "/src/ui/section/event-header/event-header-three.tsx"
          },
          {
            "slug": "event-header-four",
            "id": "event-header-four",
            "name": "Event Header Four",
            "thumbnail": "/images/ui/event-header/event-header-four.png",
            "path": "/src/ui/section/event-header/event-header-four.tsx"
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            ...
            "thumbnail": "/images/ui/event-item-header/event-item-header-one.png",
            "path": "/src/ui/section/event-item-header/event-item-header-one.tsx"
          },
          {
            "slug": "event-item-header-two",
            "id": "event-item-header-two",
            "name": "Event Item Header Two",
            "thumbnail": "/images/ui/event-item-header/event-item-header-two.png",
            "path": "/src/ui/section/event-item-header/event-item-header-two.tsx"
          },
          {
            "slug": "event-item-header-three",
            "id": "event-item-header-three",
            "name": "Event Item Header Three",
            "thumbnail": "/images/ui/event-item-header/event-item-header-three.png",
            "path": "/src/ui/section/event-item-header/event-item-header-three.tsx"
          },
          {
            "slug": "event-item-header-four",
            "id": "event-item-header-four",
            "name": "Event Item Header Four",
            "thumbnail": "/images/ui/event-item-header/event-item-header-four.png",
            "path": "/src/ui/section/event-item-header/event-item-header-four.tsx"
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            ...
            "thumbnail": "/images/ui/event-section/event-section-one.png",
            "path": "/src/ui/section/event-section/event-section-one.tsx"
          },
          {
            "slug": "event-section-two",
            "id": "event-section-two",
            "name": "Event Section Two",
            "thumbnail": "/images/ui/event-section/event-section-two.png",
            "path": "/src/ui/section/event-section/event-section-two.tsx"
          },
          {
            "slug": "event-section-three",
            "id": "event-section-three",
            "name": "Event Section Three",
            "thumbnail": "/images/ui/event-section/event-section-three.png",
            "path": "/src/ui/section/event-section/event-section-three.tsx"
          },
          {
            "slug": "event-section-four",
            "id": "event-section-four",
            "name": "Event Section Four",
            "thumbnail": "/images/ui/event-section/event-section-four.png",
            "path": "/src/ui/section/event-section/event-section-four.tsx"
          }
        ]
      },
      {
