...
export default function LinkPageFour() {
  return (
    <section
    ...
    >
      ...
      <div className="h-40">
        <Image
          className='size-full aspect-video object-cover select-none pointer-events-none'
          src='/image.svg'
          width={200}
          height={200}
      ...
      <div className="container mx-auto p-6 pt-0 sm:pb-10  md:p-12 md:pt-0 lg:pb-16">
        <div className="-mt-16 p-4 md:p-6 mx-auto max-w-lg">
          {/* Text Content */}
