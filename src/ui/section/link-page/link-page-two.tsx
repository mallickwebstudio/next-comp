...
import { FacebookIcon, LinkedinIcon, PlayCircle, TwitterIcon, YoutubeIcon } from "lucide-react";
      ...
      <div className="container mx-auto p-6 sm:py-10  md:p-12 lg:py-16">
        <div className="p-4 md:p-6 mx-auto max-w-lg">
          ...
          <div className="relative mt-6 cursor-pointer">
            <Image
              className='w-full aspect-video object-cover select-none pointer-events-none rounded-md overflow-hidden'
              src='/image-blank.svg'
              width={200}
              height={200}
