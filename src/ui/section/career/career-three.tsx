...
export default function CareerThree() {
    return (
        <section
        ...
        >
            <div className="container mx-auto p-6 sm:py-10  md:p-12 lg:py-16 grid gap-12 grid-cols-1 md:grid-cols-2">
                {/* Text Content */}
                <header>
                ...
                <div className="flex justify-center">
                    ...
                    >
                        {jobData.map((item, index) => (
                            <AccordionItem value={item.department} key={item.department + index + "CareerThree"}>
                                ...
                                <AccordionContent className="flex flex-col gap-8 text-balance">
                                    {item.jobs.map((item, index) => (
                                        <div key={item.title + index + "CareerThree"}>
