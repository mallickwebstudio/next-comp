...
export default function TimelineSectionThree() {
  return (
    <section
    ...
    >
      <div className="relative container mx-auto p-6 sm:py-10  md:p-12 lg:py-16">
        ...
        <div className="mt-12 ml-6 md:ml-0 py-8 w-[90%] md:w-full space-y-12 relative grid grid-cols-1 auto-rows-auto auto-cols-fr items-start justify-items-center ">
          {/* Timeline Observer */}
          ...
          {timelineData.map((item, index) => (
            <div
              ...
              key={item.title + index + "TimelineSectionThree"}
            >
              <div
                className={cn(
                  "relative",
                ...
                {/* Timeline dot */}
                <div className={cn(
                  "absolute -left-[31px] md:left-auto top-2 p-2 size-3 bg-foreground flex items-center justify-center outline-4 outline-background rounded-full",
