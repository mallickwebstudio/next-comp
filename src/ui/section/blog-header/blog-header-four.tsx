...
export default function BlogHeaderFour() {
      ...
      <div className="container mx-auto p-6 sm:py-10  md:p-12 lg:py-16">
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-2">
          {filteredBlogs.map((item, index) => (
            <article
              className="p-2 flex flex-col sm:flex-row md:items-center gap-4 overflow-hidden"
              key={item.title + index + "Card" + "BlogHeaderFour"}
              itemScope
              itemType="https://schema.org/BlogPosting"
            >
              <figure className="sm:w-80 aspect-square" itemProp="image" itemScope itemType="https://schema.org/ImageObject">
                <Image
