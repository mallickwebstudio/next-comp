        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2">
          {blogData.map((item, index) => (
            <article
              ...
              key={item.title + index + "Card" + "BlogCardFour  "}
              itemScope
              itemType="https://schema.org/BlogPosting"
            >
              <figure className="w-full md:w-auto md:h-full aspect-square" itemProp="image" itemScope itemType="https://schema.org/ImageObject">
                <Image
              ...
              <div className="p-3">
                <header>
                  ...
                  <h3 className="mt-2 text-lg font-semibold hover:underline line-clamp-2 md:line-clamp-1" itemProp="headline">
